...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { board_id: @column.board_id, name: @column.name } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { board_id: @column.board_id, name: @column.name } }
